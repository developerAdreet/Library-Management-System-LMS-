...
public class LibraryExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<ResponseStructure<String>> handlerlibraryIdNotFoundException(LibraryIdNotFoundException library){
		ResponseStructure<String> responseStructure = new ResponseStructure<>();
		responseStructure.setMessage("Library not found for this id!");
		responseStructure.setStatusCode(HttpStatus.BAD_REQUEST.value());
	responseStructure.setData(library.getMessage());

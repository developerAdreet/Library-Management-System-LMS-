...
public class UserExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<ResponseStructure<String>> handleUserIdNotFoundException(UserIdNotFoundException user){
		ResponseStructure<String> responseStructure = new ResponseStructure<>();
		responseStructure.setMessage("User not found for this id!");
		responseStructure.setStatusCode(HttpStatus.BAD_REQUEST.value());
	responseStructure.setData(user.getMessage());
